    ...
    if ($filas.length==0) {
        ...
        $cols.each(function() {
            ...
            if ($(this).attr('name')=='buttons') {
                ...
                htmlDat = htmlDat + '<td><input class="form-control input-sm" placeholder="请输入Header' + (i == 1 ? "键" : "值") + '"></td>';
            }
        });
        ...
        $cols.each(function() {
            ...
            if ($(this).attr('name')=='buttons') {
                ...
                $(this).html('<input class="form-control input-sm" placeholder="请输入Header' + (i == 1 ? "键" : "值") + '">');  //limpia contenido
            }
        });
    }
	params.onAdd();
